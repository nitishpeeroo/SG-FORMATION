...
(function(factory) {
	...
	$.fn.smartmenus.defaults = {
		...
		mainMenuSubOffsetY:	32,		// pixels offset from default position
		...
		showFunction:		function($ul, complete) { $ul.slideDown(0, complete); },		// custom function to use when showing a sub menu (the default is the jQuery 'show')
							// don't forget to call complete() at the end of whatever you do
							// e.g.: function($ul, complete) { $ul.fadeIn(250, complete); }
		hideDuration:		300,		// duration for hide animation - set to 0 for no animation - matters only if hideFunction:null
